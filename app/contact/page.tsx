    ...
    <div className="min-h-screen overflow-x-clip bg-[#FFFDF8] text-[#261B2E]">
      ...
      <main>
        <section className="relative overflow-hidden bg-[#35104F] px-5 py-16 text-white sm:px-8 lg:py-24">
          ...
          <div className="relative mx-auto grid max-w-[86rem] items-start gap-12 lg:grid-cols-[0.76fr_1.24fr] lg:gap-20">
            <div className="min-w-0 lg:sticky lg:top-28">
              ...
              <h1 className="display-font mt-5 max-w-[10ch] text-5xl leading-[0.9] tracking-[-0.055em] sm:text-7xl">Let&rsquo;s start the conversation.</h1>
              <p className="mt-7 max-w-md text-lg font-medium leading-8 text-white/72">Tell us what you would like help with and the best way to reach you.</p>
