...
export function AdminLoginForm() {
  ...
  return (
    <div className="min-h-screen bg-[#3D145F] px-5 py-10 text-[#35104F]">
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-xl items-center">
        <form
          className="relative w-full overflow-hidden rounded-[2.75rem] bg-[#FFFDF8] p-8 shadow-[0_30px_90px_rgba(30,9,55,0.3)] md:p-10"
          onSubmit={handleSubmit}
        >
          <div className="absolute -right-14 -top-14 h-36 w-36 rounded-[2.25rem] bg-[#F0C646]/80" />
          <Image
          ...
          <div className="relative mt-7 grid gap-4">
            <label className="grid gap-2 text-sm font-black text-[#3D145F]">
              ...
              <input
                autoComplete="email"
                className="w-full rounded-[1.35rem] border-0 bg-white px-5 py-4 text-base font-bold outline-none ring-2 ring-[#3D145F]/10 focus:ring-[#F0C646]"
            ...
            <button
              className="rounded-full bg-[#22C86B] px-7 py-4 text-base font-black text-[#143526] shadow-[0_18px_45px_rgba(44,31,61,0.18)] transition-all duration-300 hover:-translate-y-0.5 disabled:opacity-70"
