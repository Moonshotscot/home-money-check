...
export const sitePages: SitePage[] = [
  ...
  },
  {
    ...
    eyebrow: "Business checks",
    description: "A practical route for finance and bookkeeping enquiries.",
    accentColour: "#D9E1E8",
  ...
  },
  {
    ...
    eyebrow: "Business checks",
    description: "A practical route for business protection conversations.",
    accentColour: "#D9E1E8",
    selectedCheck: "Business protection",
    status: "live",
    category: "Business checks",
    metaTitle: "Business protection | Home Money Check",
    metaDescription: "Ask Home Money Check about business protection conversations.",
    intro: "This route helps organise business protection enquiries.",
