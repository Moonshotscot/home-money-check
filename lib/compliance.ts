// Compliance wording to be reviewed and approved before regulated pages are launched.
export const footerCompliance = {
  ...
  company:
    "Where Can I Find a Mortgage Ltd is registered in Scotland. Company No. SC843689. Registered Office: Suite 204 Old Embroidery Mill, Abbey Mill Business Centre, Paisley, Scotland, PA1 1TJ.",
  register:
    "Where Can I Find a Mortgage Ltd (No. 1036175) and Cornerstone Finance Group Ltd (No. 767202) are entered on the Financial Services Register.",
};
...
export const regulatedComingSoonSlugs = new Set([
  "mortgage",
...
export const mortgageComingSoonSlugs = new Set([
  "mortgage",
  "mortgage/first-time-buyer",
  "mortgage/remortgage",
  "mortgage/moving-home",
